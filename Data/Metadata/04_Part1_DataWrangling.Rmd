...
NTL.phys.data.Tues.90.99 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 >= 1990 & year4 <= 1990)
...
NTL.phys.data.temp.descending <- arrange(NTL.phys.data, temperature_C)
```
### Select

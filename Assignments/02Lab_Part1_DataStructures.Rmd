...
# multiply every element of vector1 by 10
vector1 * 10

# change text to uppercase
toupper(vector2) 

# invert the logic of each element
!vector3
...
temp_difference <- (temps_F)-mean_tempsF
...
matrix1[4, 1] # extract element in row 4 column 1

matrix1[4,  ] # extract all elements in row 4

matrix1[ , 3] # extract all elements in col 3
...
#
list1[[4]] = 44 #double brackets get the value of a specific element
...
e <- c("red", "white", "red", NA) # What type of vector? char
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # must comment before KNIT

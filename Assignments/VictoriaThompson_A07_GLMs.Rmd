...
needs to be above 0.05. For all of the pairs including Peter Lake, this includes 
Paul Lake and Ward Lake. East Long Lake and Hummingbird Lake have no pairings where
p > 0.05, meaning their mean temperatures are statistically different from 
all the other lakes.
...
statistically indistinguishable. I would not say that they are equal, but they 
are at least statistically the same.

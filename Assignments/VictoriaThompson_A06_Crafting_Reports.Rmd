...
```{r 2018 plot, fig.align='left', fig.height=5, fig.cap='Ozone Levels by Month for 2018', echo=FALSE, message=FALSE, warning=FALSE, fig.height=3}
...
```{r 2019 plot, fig.align='left', fig.height=5, fig.cap='Ozone Levels by Month for 2018', echo=FALSE, message=FALSE, warning=FALSE, fig.height=3}

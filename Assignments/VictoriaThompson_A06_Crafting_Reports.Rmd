...
ozone_2018 <- epa_data %>% 
  ...
  drop_na(Ozone) %>% 
  ggplot(
    aes(y=Ozone, x= factor(Month,levels=1:12,labels=month.abb)),
  ) +
geom_boxplot()+ labs( x='Month', y = 'Concentration (ug/m^3)', 
...
```{r 2019 plot, fig.align='left', fig.height=3, fig.cap='Ozone Levels by Month for 2019', echo=FALSE, message=FALSE, warning=FALSE}
...
https://github.com/victoriathomp/EDE_Fall2024
